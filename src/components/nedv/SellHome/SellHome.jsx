...
export default function SellHome() {
  return (
    <Stack  minH={'300px'} p={5} direction={{ base: 'column', md: 'row' }}>
      <Flex flex={3} display={'flex'} flexDirection={'column'}>
        <Text fontSize={32} fontWeight={700}>Поможем продать недвижимость быстро и выгодно</Text>
      ...
      <Image
        ...
        />
      <Flex p={5} flex={1} display={'flex'} flexDirection={'column'} >
          <p>Тип недвижимости</p>
          <Select width={294} placeholder='Выбрать' mb={5}>
          ...
          <Button  backgroundColor={'#dfebff'} color={'#2a72ee'} width={280} colorScheme='twitter'>Получить консультацию</Button>
      </Flex>
    </Stack>
  );
}
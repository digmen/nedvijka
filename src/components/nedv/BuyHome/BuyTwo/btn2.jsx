...
const ButtonBlock2 = () => {
  ...
  return (
    <div style={{ borderRadius: '10px', display: 'flex', justifyContent: 'space-between' }}>
      <button
        style={{ borderTopLeftRadius: '5px',borderBottomLeftRadius: '5px',border: activeButton === 1 ? '1px solid #2a72ee' : '1px solid #d6dadc', padding: '8px 14px', borderRight: '0' ,
